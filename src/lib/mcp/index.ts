...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for the QualiPulse quality management platform. Read agents, browse and create feedback, and view coaching sessions. All calls act as the signed-in user and respect their role and RLS policies.",
